...
our @ERROR_CODES = qw(
    ...
    FKO_ERROR_INVALID_DATA_DECODE_DEVICEID_TOOBIG
    FKO_ERROR_INVALID_DATA_DECODE_DEVICEID_DECODEFAIL
    FKO_ERROR_INVALID_DATA_DECODE_DEVICEID_VALIDFAIL
    FKO_ERROR_INVALID_DATA_DEVICEID_TOOBIG
